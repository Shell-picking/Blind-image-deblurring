...
proc create_root_design { parentCell } {
  ...
  # Create instance: fft2_0, and set properties
  set fft2_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:fft2:1.0 fft2_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins fft2_0/in_stream]
  ...
  connect_bd_intf_net -intf_net fft2_0_out_stream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins fft2_0/out_stream]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fft2_0/s_axi_CONTROL_BUS/Reg] SEG_fft2_0_Reg
